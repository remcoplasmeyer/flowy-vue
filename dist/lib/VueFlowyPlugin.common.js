...
// CONCATENATED MODULE: ./src/components/FlowyNode.vue?vue&type=template&id=3afb0769&lang=html&
...
/* harmony default export */ var FlowyNodevue_type_script_lang_js_ = ({
  ...
  updated: function updated() {
    ...
    this.$nextTick(function () {
      ...
      _this.xPosProxy = getOffset(_this.$refs.block.$el).left;
    });
  },
  computed: {
    xPos: function xPos() {
  ...
  methods: {
    ...
    onDrop: function onDrop(node, _event) {
      // console.log('ondrop', _event);
      this.hoveringWithDrag = true;
    },
    onDragStop: function onDragStop(_event) {
      console.log(_event);
    ...
    onDragReceive: function onDragReceive(_event) {
      ...
      this.hoveringWithDrag = false;
      var draggingNode = this.draggingNodeFromEvent(_event); // const dropzoneNode = this.dropzoneNodeFromEvent(_event);
...
var FlowyNode_component = normalizeComponent(
  ...
  FlowyNodevue_type_template_id_3afb0769_lang_html_render,
  FlowyNodevue_type_template_id_3afb0769_lang_html_staticRenderFns,
  false,
  null,
  null,
  null
...
/******/ });
//# sourceMappingURL=VueFlowyPlugin.common.js.map