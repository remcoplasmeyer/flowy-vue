...
export default {
  ...
  methods: {
    parseComponent (comp) {
      ...
      this.tabs = [ 'vue', 'template', 'script', 'style' ].filter(type => this.parts[type])
    },
    ...
    openGitHub () {
      openURL(`https://github.com/remcoplasmeyer/flowy-vue/tree/dev/docs/src/examples/${this.file}.vue`)
    },
